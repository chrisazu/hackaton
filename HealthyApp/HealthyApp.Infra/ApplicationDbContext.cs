    ...
    public class ApplicationDbContext : IdentityDbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Level>().HasData(
                ...
                new Level() { Id = 6, Name = "Expert", Number = 6, Description = "Estás como Angelina Jolie", Url = "" },
                new Level() { Id = 7, Name = "Elite", Number = 7, Description = "Estás como Tom Hardy", Url = "" },
                new Level() { Id = 8, Name = "Grandmaster", Number = 8, Description = "Estás como Gal Gadot", Url = "" },
                new Level() { Id = 9, Name = "Masterful", Number = 9, Description = "Estás como Chris Hemsworth", Url = "" },
